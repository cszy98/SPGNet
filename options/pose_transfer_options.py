...
class BasePoseTransferOptions(BaseOptions):
    ...
    def auto_set(self):
        ...
        if opt.dataset_name == 'market':
            ...
            opt.fn_split = 'label/split.json'
            opt.img_dir = 'img/train' if opt.is_train else 'img/test'
            opt.fn_pose = 'label/pose_label.pkl'
            opt.pretrained_flow_id = 'FlowReg_market'
            opt.seg_dir = 'seg/'
            opt.seg_pred_dir = 'seg/'
            ...
            opt.img_dir = 'img/img'
            opt.fn_pose = 'label/pose_label.pkl'
            opt.pretrained_flow_id = 'FlowReg_deepfashion'
            opt.seg_dir = 'seg/'
            opt.seg_pred_dir = 'seg/' if opt.is_train else 'pred_seg/'
