...
# fix the PATH
target_annotation = '../datasets/market1501/label/market-annotation-test.csv'
pred_annotation = '../checkpoints/PoseTransfer_market/output_pckh.csv'
...
for i in tqdm.tqdm(range(pRows)):
	...
	tnames = pname.split('_')
	tname = tnames[4]+'_'+tnames[5]+'_'+tnames[6]+'_'+tnames[7]
