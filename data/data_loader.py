...
def CreateDataset(opt, split):
    dataset = None
    if opt.dataset_type == 'pose_transfer_parsing':
        from data.pose_transfer_parsing_dataset import PoseTransferParsingDataset as DatasetClass
    elif opt.dataset_type == 'pose_transfer_parsing_market':
        from data.pose_transfer_parsing_market_dataset import PoseTransferParsingPredDataset as DatasetClass
    else:
